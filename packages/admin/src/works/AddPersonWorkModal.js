...
import { roles as worksRoles } from '@readerfront/shared/build/params/works';
      ...
      <ModalBody>
        ...
        <FormGroup>
          ...
          <Input
            ...
            onChange={onChange}
          >
            {Object.keys(worksRoles).map(role => (
              <option key={`people.rol.${role}`} value={worksRoles[role].id}>
                {f({
                  id: `people.rol.${role}`,
                  defaultMessage: role
                })}
