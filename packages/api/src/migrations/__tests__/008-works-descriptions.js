...
import { up, down } from '../008-works-descriptions';

describe('#up', () => {
  it('creates works_descriptions table', () => {
    ...
    expect(call[0]).toBe('works_descriptions');
  });
...
describe('#down', () => {
  it('drops works_descriptions table', () => {
    const queryInterface = createQueryInterfaceMock(jest.fn);
    down(queryInterface, Sequelize);
    expect(queryInterface.dropTable).toBeCalledWith('works_descriptions');
  });
});
