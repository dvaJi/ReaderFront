...
it("renders without crashing", async () => {
  ...
  wrapper.setState({ chapter: chapterGenerator(1, 0) });
  wrapper.setState({ chapters: mockChapters });
...
function chapterGenerator(chapter, subchapter) {
  return {
    id: 53,
    comic_id: "23",
    team_id: "0",
...
let mockChapters = [
  chapterGenerator(1, 0),
  chapterGenerator(2, 0),
  chapterGenerator(3, 0),
  chapterGenerator(4, 0)
];
